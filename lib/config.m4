...
PHP_ARG_ENABLE(xhprof, whether to enable Qafoo Profiler support,
[ --enable-xhprof      Enable Qafoo Profiler support])

PHP_ARG_WITH([xhprof-libcurl-dir], [],
[  --with-xhprof-libcurl-dir[=DIR]  Qafoo Profiler: where to find libcurl], $PHP_XHPROF, $PHP_XHPROF)
